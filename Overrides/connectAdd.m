...
%% Parse input
types = {'1freq' '2freq' '3freq' '3freqAll' 'All2freq' 'Allfreq' 'active' '1freqReal' 'All2freqReal'};
...
switch lower(con.type)
    ...
    case '1freqreal' % one-frequency monomials
        F = (F1 + F2)/2;
        con.nType = 8; % numerical connection type
        
    case 'all2freqreal' % Full series of resonant monomials
        F = (F1 + F2)/2;
        con.nType = 9; % numerical connection type
